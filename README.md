...
**57 fuentes en servicio**, en 59 archivos de datos: hay fuentes que dejan más de un archivo. Esta tabla no se escribe: la calcula `herramientas/sellar-portada.py` desde los archivos de datos, después de cada recolección. Un colector que no dejó dato no aparece acá.
...
| `ransomware` | ransomware.live — recopilación de sitios de extorsión informática | `D-4` | 21 | 6 |
