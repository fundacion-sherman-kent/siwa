# -*- coding: utf-8 -*-
"""Incautación de base de coca por departamento (Colombia) — Ministerio de Defensa /
Policía Nacional, datos.gov.co, id `nxbk-nikm`.

El brief detectó ~9 filas agregadas con código de departamento espurio; se
...
COLECTOR = "subnacional_colombia_incautacion_base_coca"
DATASET_ID = "nxbk-nikm"


def construir():
    return base.construir_indicador(
        colector=COLECTOR, dataset_id=DATASET_ID,
        titulo="Incautación de base de coca",
        nota="Kilogramos de base de coca incautados por la Policía Nacional, por "
